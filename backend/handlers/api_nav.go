...
func (c *config) GetNavItems(w http.ResponseWriter, r *http.Request) {
...
func (c *config) CreateNavItems(w http.ResponseWriter, r *http.Request) {
...
func (c *config) UpdateNavItem(w http.ResponseWriter, r *http.Request) {
...
func (c *config) DeleteNavItems(w http.ResponseWriter, r *http.Request) {
	type parameters struct {
		Name string `json:"name"`
	}
